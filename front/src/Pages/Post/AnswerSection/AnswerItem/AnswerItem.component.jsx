    ...
    <Fragment>
      <div className='answer-layout'>
              ...
              question.user.seq === user.seq ? (
                answer.accept === true ? (
                  <div title='이 답변을 채택하셨습니다'>
                    <svg
                      aria-hidden='true'
                      class='svg-icon iconCheckmarkLg fc-green-500'
                      width='36'
                      height='36'
                      viewBox='0 0 36 36'
                      color='#999'
                  ...
                  <div title='이 답변을 채택하시겠습니까?' onClick={() => acceptAnswer(answer.seq)}>
                    <svg
                      aria-hidden='true'
                      class='svg-icon iconCheckmarkLg fc-green-200'
                      width='36'
                      height='36'
                      viewBox='0 0 36 36'
                      color='#999'
        ...
        <div className='answer-item'>
          <div className='answer-content fc-black-800' dangerouslySetInnerHTML={{ __html: answer.content }}></div>
