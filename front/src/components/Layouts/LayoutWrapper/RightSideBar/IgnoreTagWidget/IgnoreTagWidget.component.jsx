...
// import { deleteIgnoreTag, postIgnoreTag } from "../../../../../api/tags" 주시태그 삭제, 추가 api
// import { } tag슬라이스에 무시태그를 얻는액션

function IgnoreTagWidget() {
  // 태그 핸들용 변수
  // const { ignoreTags } = useSelector(무시 태그를 얻는 액션)

  // dispatch용 useDispatch

  // COUNTRIES 대신에 ignoreTags
